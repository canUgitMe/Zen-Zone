...
const AboutUs = ({ isDarkMode, setPage }) => {
  return (
    <div className={`zen-page-center ${isDarkMode ? '' : 'dark-mode'}`}>
      ...
      >
        ...
        {/* Bottom-right Glassmorphic Button */}
        {/* Bottom-right Glassmorphic Button with Theme Support */}
<div
  className={`know-more-floating-btn ${isDarkMode ? 'dark' : 'light'}`}
